            ...
            <div className="min-h-screen bg-amber-50 flex flex-col justify-center items-center p-4 relative">
                ...
                <div className="w-full max-w-md relative z-10">
                    ...
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                        <div className="p-8">
                            <h2 className="text-2xl font-semibold text-center mb-6 text-amber-800">Welcome Back!</h2>
                        ...
                        <div className="px-8 py-4 bg-amber-100 text-center">
                            <p className="text-sm text-amber-800">
                                ...
                                <Link to="/register" className="ml-1 font-semibold text-amber-600 hover:underline focus:outline-none">
                                    Sign up
                                </Link>
                            </p>
                        </div>
